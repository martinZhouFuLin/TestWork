...
import zltd.com.testwork.utils.PxUtils;
...
public class DrawView extends View {
    ...
    public DrawView(Context context) {
        super(context, null);
        LogUtils.Companion.i("debug", "draw1");
    }

    public DrawView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        LogUtils.Companion.i("debug", "draw2");
    ...
    public DrawView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LogUtils.Companion.i("debug", "draw3");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtils.Companion.i("debug", "draw4");
        ...
        if (widthMode == MeasureSpec.EXACTLY && heightMode == MeasureSpec.EXACTLY) {
            ...
            mWidth = widthSize;
            mHeight = heightSize;
            LogUtils.Companion.i("debug", "w+h1==" + mWidth + "==" + mHeight);
        }
        if (widthMode == MeasureSpec.AT_MOST && heightMode == MeasureSpec.AT_MOST) {
            ...
            x = mRadius;
            y = mRadius;
            LogUtils.Companion.i("debug", "w+h2==" + mWidth + "==" + mHeight);
        }
        LogUtils.Companion.i("debug", "w+h3==" + mWidth + "==" + mHeight);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        LogUtils.Companion.i("debug", "w+h0==" + x + "==" + y);
        ...
        LogUtils.Companion.i("debug", "result==" + mWidth + "==" + mRadius * 2);
